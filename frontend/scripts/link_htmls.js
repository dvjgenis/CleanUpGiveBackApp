...
const screenMap = {
  ...
  'SCREEN_96': 'sessions_list_view___standardized_refined.html',
  ...
  'SCREEN_63': 'sessions_list_view___standardized_refined.html',
...
files.forEach(file => {
  ...
  content = content.replace(/\{\{DATA:SCREEN:(SCREEN_[0-9]+)\}\}/g, (match, p1) => {
    if (screenMap[p1]) {
      return screenMap[p1];
    }
