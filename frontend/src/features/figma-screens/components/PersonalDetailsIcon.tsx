...
/** Personal Details section icon — simple person glyph (no Figma node available). */
export function PersonalDetailsIcon({ width = 16, height = 16, color = colors.textTertiary }: Props) {
  return (
