...
assertContains('background-color:#fcab29', 'amber CTA light');
assertContains('color:#004d21', 'CTA text color');
assertContains('prefers-color-scheme: dark', 'dark-mode CTA query');
assertContains('supported-color-schemes" content="light"', 'light-only color scheme');
assertContains('background-color: #c2d832 !important', 'lime CTA dark');
