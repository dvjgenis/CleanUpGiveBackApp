  ...
  return (
    <div className="flex flex-col gap-md">
      ...
      <div className="bg-bg-surface border border-border-outline rounded-md overflow-hidden">
        <div className="grid grid-cols-[1fr_auto_auto_auto] gap-md px-lg py-sm bg-bg-surface-elevated border-b border-border-outline">
        ...
        {rows.length === 0 ? (
          ...
          <ul role="list" className="divide-y divide-border-outline max-h-[420px] overflow-y-auto">
            {[...rows].reverse().map((row) => (
              <li key={row.key} className="grid grid-cols-[1fr_auto_auto_auto] gap-md items-center px-lg py-sm">
