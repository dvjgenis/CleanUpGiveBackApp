...
/** Ported from `admin/app/(admin)/events/[id]/NotifyAtRiskVolunteers.tsx`. */
...
export function NotifyAtRiskVolunteers({
  ...
  return (
    <section className="bg-bg-surface border border-border-outline rounded-md p-lg">
      <h2 className="font-heading text-[18px] leading-[26px] text-text-primary mb-xs">
        Notify at-risk volunteers
      </h2>
