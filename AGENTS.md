...
- Shipping for Donna: Phase 1 Pirate Ship labels + paste tracking in Orders UI + Resend email; Phase 2 Shippo at higher volume (see `docs/research/shipping-integration-2026-08.md`). Checkout offers pickup/local vs shipped; app charges for access, not kit cost. Shop USPS shipping is 25% of paid product subtotal (free cleanup kit ignored). Free cleanup kit confirmation emails should show free shipping and a $59.99 total.
