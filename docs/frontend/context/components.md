...
| AccountScreen | `screens/AccountScreen.tsx` | Account tab (Figma `569:896`); profile hero, Records/Shop/Preferences/Permissions; Preferences includes **Give Feedback** → `/give-feedback`; Camera/Location/Notifications toggles wired to OS permission request + Settings fallback; Profile nav active |
